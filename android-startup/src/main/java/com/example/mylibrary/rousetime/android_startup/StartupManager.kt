...
import com.example.mylibrary.rousetime.android_startup.annotation.MultipleProcess
import com.example.mylibrary.rousetime.android_startup.dispatcher.StartupManagerDispatcher
import com.example.mylibrary.rousetime.android_startup.execption.StartupException
import com.example.mylibrary.rousetime.android_startup.manager.StartupCacheManager
import com.example.mylibrary.rousetime.android_startup.model.LoggerLevel
...
import com.example.mylibrary.rousetime.android_startup.sort.TopologySort
import com.example.mylibrary.rousetime.android_startup.utils.ProcessUtils
...
class StartupManager private constructor(
    ...
    private val mDefaultManagerDispatcher by lazy {
        StartupManagerDispatcher(
            context, needAwaitCount, mAwaitCountDownLatch, startupList.size, config.listener
        )
    }
    ...
    class Builder {
        ...
        fun build(context: Context): StartupManager {
            ...
            return StartupManager(
                ...
                realStartupList,
                mNeedAwaitCount,
                mConfig ?: StartupConfig.Builder().setLoggerLevel(mLoggerLevel)
                    .setAwaitTimeout(mAwaitTimeout).build()
            )
        }
    }
